...
import { Header, Footer, StockChartTest, getPeriodName } from "../../components";
...
export const TestPage: React.FC = () => {
    ...
    const labels = useSelector((state) => state.periodChange.labels)
    ...
    return <div>
        ...
        <div className={styles.content}>
            <StockChartTest title={title} data={data}
                ...
                type={searchType} enableTimer={true} labels={labels}></StockChartTest>
