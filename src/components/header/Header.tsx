...
interface Props {
    type: "home" | "list" | "filter" | "block" | "three" | "test" | "test1"
}
...
export const Header: React.FC<Props> = (prop) => {
    ...
    return <div className={styles.content}>
        ...
        {!isMobile && (
            ...
            <Button type="text" onClick={navTestPage1} className={prop.type == 'test1' ? styles.navbtnSelect : styles.navbtn}>策略测试</Button>
